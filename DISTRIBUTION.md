...
| **PyPI** | ✅ live | https://pypi.org/project/vulngate/ (latest). `pip install "vulngate[scanners]"` / `[mcp]` works. Re-publish with `python -m build && twine upload dist/*` (twine ≥ 7 — hatchling now emits Metadata-Version 2.5). |
